...
from dataset import LlavaFinetuneDataset, LlavaCollator, split_data_to_train_and_val
from model import LitMultiModalGPT, model_summary
...
class PeriodicCheckpoint(ModelCheckpoint):
    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx):
        if batch_idx % self.save_freq == 0:
            ...
            print("Saving checkpoint for resnet layer")
            resnet_file_name = os.path.join(self.save_dir, f"resnet_layer_ckpt_finetuning_{trainer.global_step}.pt")
            torch.save(trainer.model.resnet_layer.state_dict(), resnet_file_name)
...
if __name__ == '__main__':
    ...
    json_path = 'annotations/llava_instruct_150k.json'
    batch_size = 1
    ...
    log_dir = './logs'
    lr = 1e-4
    stage1_projection_checkpoints = 'stage1_checkpoints/projection_layer_ckpt.pt'
    stage1_resnet_checkpoints = 'stage1_checkpoints/resnet_layer_ckpt.pt'
    ...
    multimodal_gpt_model.resnet_layer.load_state_dict(torch.load(stage1_resnet_checkpoints))
