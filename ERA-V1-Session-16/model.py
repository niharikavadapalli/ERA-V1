...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  1 12:31:14 2023
...
def build_transformer(src_vocab_size: int, tgt_vocab_size: int, src_seq_len: int, tgt_seq_len: int, d_model: int=512, N: int=6, h: int=8, dropout: float=0.1, d_ff: int=2048, param_sharing = True) -> Transformer:
    ...
    if param_sharing:
        e1, e2, e3, e4, e5, e6 = encoder_blocks
        d1, d2, d3 ,d4, d5, d6 = decoder_blocks
        encoder_blocks1 = [e1, e2, e3, e4, e5, e6, e6, e5, e4, e3, e2, e1]
        decoder_blocks1 = [d1, d2, d3 ,d4, d5, d6, d6, d5, d4, d3, d2, d1]
